  ...
  function updateSliderPos(lenisSc, delta) {
      ...
      if (!allowScroll) {
        ...
        if (delta > 0) { //DOWN
          ...
          console.log("slidePos: " + $(".slide-wrap").offset().top);
          ...
          if (allowScroll && (lenisSc > $(".slide-wrap").offset().top) && !belowSlide) {
            allowScroll = false;
          ...
          if (allowScroll && (lenisSc < ($(".slide-wrap").offset().top + 25)) && belowSlide) {
            allowScroll = false;
            $("#slide-wrap").addClass("fixed");
            lenis.stop();
            isAnimating = true;
